...
var Component = styled__default['default'].div.withConfig({
...
var _excluded$4 = ["fbappid", "size", "facebookPath", "facebookProps", "twitterPath", "twitterProps", "whatsappPath", "whatsappProps"];
...
var HeadingOne = styled__default['default'].h1.withConfig({
  displayName: "styled__HeadingOne",
  componentId: "sc-1bxdmvf-0"
})(["", ""], function (props) {
  return props.$style;
});
var HeadingTwo = styled__default['default'].h2.withConfig({
  displayName: "styled__HeadingTwo",
  componentId: "sc-1bxdmvf-1"
})(["", ""], function (props) {
  return props.$style;
});
var HeadingThree = styled__default['default'].h3.withConfig({
  displayName: "styled__HeadingThree",
  componentId: "sc-1bxdmvf-2"
})(["", ""], function (props) {
  return props.$style;
});
var HeadingFour = styled__default['default'].h4.withConfig({
  displayName: "styled__HeadingFour",
  componentId: "sc-1bxdmvf-3"
})(["", ""], function (props) {
  return props.$style;
});
var HeadingFive = styled__default['default'].h5.withConfig({
  displayName: "styled__HeadingFive",
  componentId: "sc-1bxdmvf-4"
})(["", ""], function (props) {
  return props.$style;
});
var HeadingSix = styled__default['default'].h6.withConfig({
  displayName: "styled__HeadingSix",
  componentId: "sc-1bxdmvf-5"
})(["", ""], function (props) {
  return props.$style;
});
var Paragraph$1 = styled__default['default'].p.withConfig({
...
var Cite = styled__default['default'].cite.withConfig({
  displayName: "styled__Cite",
  componentId: "sc-1bxdmvf-9"
})(["", ""], function (props) {
  return props.$style;
});
var A = styled__default['default'].a.withConfig({
...
var _excluded$3 = ["children", "color", "element", "fontSize", "fontFamily", "fontWeight", "href", "lineHeight", "textAlign", "transform", "mx", "my", "mt", "mb", "ml", "mr", "px", "py", "pt", "pb", "pl", "pr", "bt", "br", "bb", "bl", "b", "borderColor", "borderStyle", "xs", "sm", "md", "lg", "xl", "theme", "custom", "width", "fullWidth", "maxWidth", "minWidth", "opacityOnHover", "target", "dangerouslySetInnerHTML"];
...
})(["", ";height:max-content;width:100%;@media (min-width:", "){width:", ";height:", ";}"], margin, function (props) {
  return props.theme.queries.md;
}, function (props) {
  return props.$width;
}, function (props) {
...
var AnchorTag = styled__default['default'].a.withConfig({
  displayName: "Anchor__AnchorTag",
  componentId: "sc-136brqd-0"
...
var TopImage = function TopImage(_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Container$2, {
    ...
    mb: mb,
    value: value
  }, /*#__PURE__*/React__default['default'].createElement(RenderMedia, null), caption && caption.show && /*#__PURE__*/React__default['default'].createElement(SubtitleBox, null, /*#__PURE__*/React__default['default'].createElement(Subtitle, {
    fontFamily: fontFamily,
    fontSize: fontSize,
    lineHeight: lineHeight
  }, caption_value)));
  ...
  var switchNode = function switchNode(obj) {
    ...
    if (tag === 'a' && attr["class"] && attr["class"] === 'p-smartembed') {
      ...
      if (!attr.href) {
        ...
        tagItems.push({
          'type': 'text',
          'value': "<a href=\"".concat(attr.href, "\" target=\"_blank\" rel=\"noreferrer\">").concat(child_string, "</a>")
        });
        return true;
      }
    }
...
var TextBody = function TextBody(props) {
  ...
  var render_paragraph = function render_paragraph(value) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Paragraph, _extends({}, paragraph, {
      maxWidth: bodyWidth,
      value: value
    })), adsRender && intervention_status && /*#__PURE__*/React__default['default'].cloneElement(adsRender, {
      amp: amp,
      content: ad_content
    }));
  };
...
TextBody.propTypes = {
  ads: PropTypes__default['default'].object,
...
var Article = function Article(props) {
  ...
  var adTopImage = lodash.get(ads, 'topImage', false);
  var adTopBody = lodash.get(ads, 'topBody', false);
  return /*#__PURE__*/React__default['default'].createElement(Page, null, /*#__PURE__*/React__default['default'].createElement(Container$8, null, featured && featured.enabled ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(ContainerFeatured, null, /*#__PURE__*/React__default['default'].createElement(ContentImage, null, /*#__PURE__*/React__default['default'].createElement(TopImage, topimage)), /*#__PURE__*/React__default['default'].createElement(ContentFeatured, {
    ...
    maxWidth: headWidth
  }, /*#__PURE__*/React__default['default'].createElement(Content$4, null, /*#__PURE__*/React__default['default'].createElement(Subject$1, subject), /*#__PURE__*/React__default['default'].createElement(Title, title), /*#__PURE__*/React__default['default'].createElement(Subtitle$1, subtitle), /*#__PURE__*/React__default['default'].createElement(Byline, _extends({
    amp: amp
    ...
    amp: amp
  }, topimage))), adTopBody && /*#__PURE__*/React__default['default'].cloneElement(adTopBody)), /*#__PURE__*/React__default['default'].createElement(TextBody$1, {
    ads: adsBody,
    amp: amp,
    bodyWidth: bodyWidth,
    citation: citation,
...
var _excluded$2 = ["children", "color", "height", "viewBox", "width"];
...
var Hyperlink = styled__default['default'].a.withConfig({
...
var GroupSection = styled__default['default'].section.withConfig({
...
var GroupTitleContainer = styled__default['default'].div.withConfig({
...
var GroupContent = styled__default['default'].div.withConfig({
...
var Carousel = function Carousel(_ref) {
  var children = _ref.children,
      height = _ref.height,
      querie = _ref.querie;
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("amp-carousel", {
    layout: "fixed",
    height: height[0],
    media: "(max-width: ".concat(querie, ")"),
    width: "100%",
    type: "carrossel"
  }, children), /*#__PURE__*/React__default['default'].createElement("amp-carousel", {
    layout: "fixed",
    height: height[1],
...
var index$4 = styled.withTheme(Carousel);
...
var Button$2 = styled__default['default'].button.withConfig({
...
var TEASER_IMAGE_FOUR = {
    box: {
        pb: [3, 3],
        pt: [0, 0],
        height: ['auto', '460px', '420px'],
    },
    box_wrap: {
        aligny: ['top', 'top'],
        height: ['auto', '460px'],
...
var TEASER_LEFTIMAGE_SMALL = {
    box: {
        align: ['row', 'row'],
        aligny: ['top', 'top'],
        height: ['auto', '144px', '100px'],
        pb: [2, 2],
        pt: [2, 2],
        mb: [1, 1]
    },
    ...
    title: {
        enabled: true,
        font_size: ['18px', '18px'],
        line_height: ['22px', '22px'],
        mb: ['0px', '0px']
    },
    section: SECTION_DEFAULT,
    subject: __assign(__assign({}, SUBJECT_DEFAULT), { mb: [1, 1] }),
    subtitle: {
        enabled: false
    }
};
var TEASER_LEFTIMAGE_LARGE = {
    box: {
        align: ['column', 'row'],
        aligny: ['top', 'top'],
        height: ['auto', 'auto'],
    ...
    title: {
        enabled: true,
        font_size: ['22px', '28px'],
        line_height: ['26px', '30px'],
        mb: [1, 1]
    },
    section: SECTION_DEFAULT,
    subject: __assign(__assign({}, SUBJECT_FILLED), { font_size: ['14px', '14px'], line_height: ['16px', '16px'], mb: [1, 1] }),
    subtitle: {
        enabled: false
    }
};
var TEASER_MOSTREAD = {
    ...
    box_wrap: {
        width: ['calc(100% - 80px)', 'calc(100% - 80px)'],
    },
    datetime_enabled: false,
    image: {
        enabled: false,
...
Field.propTypes = {
  ...
  styledLabel: PropTypes__default['default'].shape({
    ...
    color: PropTypes__default['default'].oneOf(colors_props),
    mt: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number]),
    mr: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number]),
    mb: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number]),
    ml: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number])
...
var Image = function Image(_ref) {
  var custom_class = _ref.custom_class,
      title = _ref.title,
      mobile_height = _ref.mobile_height,
      mobile_path = _ref.mobile_path,
      mobile_width = _ref.mobile_width,
      _ref$mobile_layout = _ref.mobile_layout,
      mobile_layout = _ref$mobile_layout === void 0 ? 'responsive' : _ref$mobile_layout,
      desktop_height = _ref.desktop_height,
      desktop_path = _ref.desktop_path,
      desktop_width = _ref.desktop_width,
      _ref$desktop_layout = _ref.desktop_layout,
      desktop_layout = _ref$desktop_layout === void 0 ? 'responsive' : _ref$desktop_layout;
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, mobile_path && /*#__PURE__*/React__default['default'].createElement("amp-img", {
    alt: title,
    "class": "amp_mobile ".concat(custom_class),
    src: mobile_path,
    ...
    alt: title,
    "class": "amp_desktop ".concat(custom_class),
    src: desktop_path,
...
var Link = styled__default['default'].a.withConfig({
  displayName: "Link",
  componentId: "sc-3802zt-0"
})(["color:inherit;cursor:pointer;text-decoration:underline;width:100%;"]);
...
var Typography = styled__default['default'].span.withConfig({
