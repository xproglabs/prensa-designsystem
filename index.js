...
Topbar.propTypes = {
  content: PropTypes__default['default'].shape({
    leftContent: PropTypes__default['default'].oneOf([PropTypes__default['default'].func, PropTypes__default['default'].object, PropTypes__default['default'].array, PropTypes__default['default'].node]),
    centerContent: PropTypes__default['default'].oneOf([PropTypes__default['default'].func, PropTypes__default['default'].object, PropTypes__default['default'].array, PropTypes__default['default'].node]),
    rightContent: PropTypes__default['default'].oneOf([PropTypes__default['default'].func, PropTypes__default['default'].object, PropTypes__default['default'].array, PropTypes__default['default'].node])
  }),
