...
export declare type SpacingType = number | string | [number, number] | [string, string] | [number, string] | [string, number];
declare type BoxTypes = {
    align?: [string, string];
...
export declare type TeaserProps = {
    /**
