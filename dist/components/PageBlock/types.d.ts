...
export declare type TemplateType = 'template100' | 'template7030' | 'template50' | 'template30';
export declare type SlotBlockProps = {
    bgcolor?: ColorTokens;
    color: ColorTokens;
    icon: IconTokens;
    link: string;
...
export declare type PageBlockProps = {
    amp?: boolean;
    bgcolor?: ColorTokens;
    cid: string;
    domain: string;
...
export declare type RenderSectionTitleParams = {
