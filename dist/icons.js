...
styled__default["default"].a.withConfig({
...
styled__default["default"].section.withConfig({
...
var TeaserProfile = function (_a) {
    ...
    return (React__default["default"].createElement(ResponsiveWrap, { className: className },
        React__default["default"].createElement(Content$4, __assign({}, containerProps),
            React__default["default"].createElement(Link$1, { path: href },
                React__default["default"].createElement(ImageWrap, __assign({}, imageWrapProps, imageBoxWidth, { mr: 1 }),
            ...
            React__default["default"].createElement(TitleWrapper, null,
                title &&
                    React__default["default"].createElement(Block$1, { alignx: 'left', align: 'row', width: '100%' },
                        React__default["default"].createElement(Link$1, { path: href },
                            React__default["default"].createElement(Title$1, __assign({}, titleProps), title))),
                name &&
...
var Content$1 = styled__default["default"].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  amp-img {\n    height: 360px;\n    width: 100%;\n    img {\n      object-fit: contain;\n      object-position: center;\n    }\n  }\n  @media (min-width: ", ") {\n    amp-img {\n      height: 500px;\n      width: 768px;\n    }\n  }\n"], ["\n  amp-img {\n    height: 360px;\n    width: 100%;\n    img {\n      object-fit: contain;\n      object-position: center;\n    }\n  }\n  @media (min-width: ", ") {\n    amp-img {\n      height: 500px;\n      width: 768px;\n    }\n  }\n"])), function (props) { return props.theme.queries.md; });
...
var AmpImageGallery = function (_a) {
    ...
    return (React__default["default"].createElement("amp-carousel", { lightbox: true, height: '548', layout: 'responsive', type: 'slides', width: '768' }, lodash.map(items, function (item, key) { return (React__default["default"].createElement(Content$1, { key: key },
...
var WebImageGallery = function (_a) {
    ...
    return (React__default["default"].createElement(WebCarousel, { showIndicators: false, showStatus: false, showThumbs: false, renderArrowPrev: renderArrowPrev, renderArrowNext: renderArrowNext }, lodash.map(items, function (item, key) {
        return React__default["default"].createElement(Content$1, { key: key },
...
var ImageGallery = function (_a) {
    ...
    return (React__default["default"].createElement(Container$4, { "$height": height, "$width": width },
...
var FacebookEmbed = function (_a) {
    ...
    return (React__default["default"].createElement(Container$3, { "$height": height, "$width": width, mt: mt, mr: mr, mb: mb, ml: ml }, amp ? React__default["default"].createElement(Amp, null) : React__default["default"].createElement(Web, null)));
};
...
const Article = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Page, null, /*#__PURE__*/React__default["default"].createElement(Container$6, null, featured && featured.enabled ? /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(ContainerFeatured, null, /*#__PURE__*/React__default["default"].createElement(ContentImage, null, /*#__PURE__*/React__default["default"].createElement(TopImage, topimage)), /*#__PURE__*/React__default["default"].createElement(ContentFeatured, {
    maxWidth: headWidth
    ...
    maxWidth: headWidth
  }, /*#__PURE__*/React__default["default"].createElement(Content$3, null, /*#__PURE__*/React__default["default"].createElement(Byline, _extends({
    amp: amp
    ...
    maxWidth: headWidth
  }, /*#__PURE__*/React__default["default"].createElement(Content$3, null, /*#__PURE__*/React__default["default"].createElement(Subject$1, subject), /*#__PURE__*/React__default["default"].createElement(Title, title), /*#__PURE__*/React__default["default"].createElement(Subtitle$1, subtitle), /*#__PURE__*/React__default["default"].createElement(Byline, _extends({
    amp: amp,
    fbappid: fbappid,
    pageUrl: url
...
const Content = styled.withTheme(ThemedContent);
Content.propTypes = {
  children: PropTypes__default["default"].object
};
({
...
styled.withTheme(TemplateContainer);
...
exports.IcFacebook = IconFacebook;
exports.IcSearch = SvgIcSearch;
exports.IcTwitter = IconTwitter;
exports.IcWhatsApp = IconWhatsApp;
