...
const dummyImage = (contentId, link) => `<p><a class="p-smartembed" data-href="${link}" data-attr-f="default" data-attr-q="1" data-attr-w="400" data-onecms-id="policy:${contentId}" data-onecms-type="image" href="javascript:window.parent.actionEventData({$contentId:'${contentId}', $action:'view', $target:'work'})" polopoly:contentid="policy:${contentId}"><img src="/image/policy:${contentId}/gui_3224.jpg?f=default&amp;w=1200&amp;q=1" /></a></p>\r\n\r\n`
