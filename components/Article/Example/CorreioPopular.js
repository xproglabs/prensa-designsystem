...
import { theme as acritica } from '../../../styles/demo/correiopopular'
...
const dummyTikTok = () => '<blockquote class="tiktok-embed" cite="https://www.tiktok.com/@reeh__augusto/video/7068678151890685190" data-video-id="7068678151890685190" data-video-id="7068678151890685190" style="max-width: 605px;min-width: 325px;" > <section> <a target="_blank" title="@reeh__augusto" href="https://www.tiktok.com/@reeh__augusto">@reeh__augusto</a> O JOGO DA DISCÓRDIA DA GATA 🤣🤣🤣 <a title="bbb22" target="_blank" href="https://www.tiktok.com/tag/bbb22">#bbb22</a> <a target="_blank" title="♬ som original - Reeh Augusto" href="https://www.tiktok.com/music/som-original-7068678169100765957">♬ som original - Reeh Augusto</a> </section> </blockquote> <script async src="https://www.tiktok.com/embed.js"></script>'

const ArticleCorreioPopular = () => {
    ...
    <ThemeProvider theme={acritica}>
      <Article
        ...
        byline={{
          author: {
            color: 'neutral2',
            email: 'jornalista@correiopopular.com',
            fontFamily: 'secondary',
            fontSize: ['14px', '14px'],
            lineHeight: ['120%', '120%'],
            value: 'Redação Correio Popular'
          },
          datetime: {
            color: 'neutral4',
            fontFamily: 'secondary',
...
export default ArticleCorreioPopular